...
#define MyAppName "Astrometric Instruments DomePro X2 PlugIn"
...
AppId={{3A36559C-96C6-4AC3-8FCA-5176795DBB6C}
AppName={#MyAppName}
...
OutputBaseFilename=DomePro_X2_Installer
...
Source: "domelist DomePro.txt";                     DestDir: "{app}\Miscellaneous Files"; Flags: ignoreversion; DestName: "domelist64 DomePro.txt"
; 32 bits
Source: "libDomePro\Win32\Release\libDomePro.dll";  DestDir: "{app}\Plugins\DomePlugIns"; Flags: ignoreversion
...
; 64 bits
Source: "libDomePro\x64\Release\libDomePro.dll";    DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "domepro.ui";                               DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "domeprodiag.ui";                           DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "domeshutter.ui";                           DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "dometimeouts.ui";                          DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
Source: "Astrometric.png";                          DestDir: "{app}\Plugins64\DomePlugIns"; Flags: ignoreversion; Check: DirExists(ExpandConstant('{app}\Plugins64\DomePlugIns'))
